function [crashProbWCertainty, crashProbWUncertainty, actualEqs, assumedEqs] = AgentSlopeUncertainty(worldParams, granularity)
	...
	[optimalBeta, optimalCrashProb, actualEqs] = GetOptimalBeta(trueParams);
	...
	[inducedBehavior, assumedEqs] = GetEqBehavior(assumedParams, betaMat);
